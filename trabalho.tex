...
I would like to thank Vale S.A. for funding this study that's part of the research program Catedra de Vagões. I also would like to thank my advisor, Prof. Auteliano Antunes dos Santos Junior, for all the guidance and support throughout this project. I want to express my gratitude to my friends Arthur and Theo for helping me during the development of this work. Finally, I would like to thank my parents Tatiana and Marcio for their unconditional support and encouragement throughout my academic journey.
\end{agradecimentos}
% ----------------------------------------------------------
% ----------------------------------------------------------
% EPÍGRAFE (OPCIONAL)
...
\begin{siglas}
	...
	\item[EFVM] Estrada de Ferro Vitória a Minas
\end{siglas}
% ----------------------------------------------------------
% ----------------------------------------------------------
...
% ---
\input{Capitulos_escritos/Lit_review}
\input{Capitulos_escritos/methodology}
% ---
% --------------------
% FIM DOS EXEMPLOS
% --------------------
