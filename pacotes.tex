...
% ----------------------------------------------------------
\usepackage[portuguese,onelanguage,linesnumbered,ruled,vlined,commentsnumbered]{algorithm2e}	% para inserir algoritmos (longend,vlined)
\usepackage{float}
...
\usepackage[brazilian]{cleveref}			% Referência cruzada inteligente
