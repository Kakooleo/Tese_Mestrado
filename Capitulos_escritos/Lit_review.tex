...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Time and frequency representations of the signals defined in Equations \ref{eq-xA} and \ref{eq-xB}. \textbf{(a)} Time and frequency representations of the signal $x_1$. \textbf{(b)} Time and frequency representations of the signal $x_2$.}
\end{figure}
...
In this section, it is presented some of the most important time-frequency distributions (TFDs). The core idea behind TFDs is to provide a joint representation of a signal such that the area under the TFD surface corresponds to the energy of the signal, that is, the TFD is an energy density function \cite{Boashash2016Chapter2HeuristicFormulation}. Ideally, for a monocomponent signal, the ideal FTD would concentrate all the energy of the signal along its IF \cite{stankovic2014instantaneous}. 
