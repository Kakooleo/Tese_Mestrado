...
\subsection{Power Spectrum Distribution} \label{sec-PSD}
...
The reasons for using $z(t)$ and the HT instead of $s(t)$ are \textcolor{red}{COLOCAR AQUI DPS}.
...
In this section, the concept of time-frequency distributions (TFDs) will be introduced. TFDs are mathematical tools that provide a joint representation of a signal in both time and frequency domains simultaneously. This dual representation allows for a more comprehensive analysis of non-stationary signals, where the frequency content changes over time.
